...
| `DeltaT_core` | Temperature drop across SPHERE thermal core | K |
...
Auxiliary power is a secondary use of remaining captured heat and is evaluated separately in docs/08-auxiliary-power.md. It must not be treated as a primary heat-allocation priority.
